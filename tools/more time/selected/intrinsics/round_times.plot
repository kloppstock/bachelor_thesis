...
plot "round_time.csv" using 1:6 with linespoints dashtype 3 pointtype 4 lw 1 t "Set 1 (10 Bildpaare)", \
	...
	"round_time_mpi.csv" using 1:6 with linespoints dashtype 3 pointtype 5 lw 3 lc 1 t "Set 1 (10 Bildpaare)", \
	 "round_time_mpi.csv" using 1:7 with linespoints dashtype 3 pointtype 7 lw 3 lc 2 t "Set 2 (5 Bildpaare)", \
	 "round_time_mpi.csv" using 1:8 with linespoints dashtype 3 pointtype 9 lw 3 lc 3 t "Set 3 (1 Bildpaare)", \
	 "round_time_mpi.csv" using 1:9 with linespoints dashtype 3 pointtype 11 lw 3 lc 4 t "Set 3 (2 Bildpaare)"
...
plot "round_time.csv" using 1:3 with linespoints dashtype 3 pointtype 4 lw 1 t "Lenses 200 (21 Bildpaare)", \
	...
	"round_time_mpi.csv" using 1:3 with linespoints dashtype 3 pointtype 5 lw 3 lc 1 t "Lenses 200 (21 Bildpaare)", \
	 "round_time_mpi.csv" using 1:4 with linespoints dashtype 3 pointtype 7 lw 3 lc 2 t "Lenses 500 (11 Bildpaare)", \
	 "round_time_mpi.csv" using 1:5 with linespoints dashtype 3 pointtype 9 lw 3 lc 3 t "Lenses 1500 (14 Bildpaare)"
