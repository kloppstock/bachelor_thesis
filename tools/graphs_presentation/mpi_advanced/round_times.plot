set terminal postscript eps color size 2.2, 2.2 font "Times,10"
...
plot "round_time.csv" using 1:6 with linespoints dashtype 3 pointtype 4 lw 1 t "Referenz - Set 1 (10 Bildpaare)", \
	 ...
	 "round_time.csv" using 1:8 with linespoints dashtype 3 pointtype 8 lw 1 t "Referenz - Set 3 (1 Bildpaare)", \
