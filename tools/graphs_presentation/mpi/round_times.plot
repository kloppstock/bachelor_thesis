set terminal postscript eps color size 2, 2 font "Times,10"
...
plot "round_time.csv" using 1:6 with linespoints dashtype 3 pointtype 4 lw 1 t "Referenz - Set 1 (10 Bildpaare)", \
	...
	"round_time_mpi.csv" using 1:6 with linespoints dashtype 3 pointtype 5 lw 3 lc 1 t "{/Times:Italic mpi} - Set 1 (10 Bildpaare)", \
	 "round_time_mpi.csv" using 1:7 with linespoints dashtype 3 pointtype 7 lw 3 lc 2 t "{/Times:Italic mpi} - Set 2 (5 Bildpaare)", \
	 "round_time_mpi.csv" using 1:8 with linespoints dashtype 3 pointtype 9 lw 3 lc 3 t "{/Times:Italic mpi} - Set 3 (1 Bildpaar)", \
...
plot "round_time.csv" using 1:3 with linespoints dashtype 3 pointtype 4 lw 1 t "Referenz - Lenses 200 (21 Bildpaare)", \
	...
	"round_time_mpi.csv" using 1:3 with linespoints dashtype 3 pointtype 5 lw 3 lc 1 t "{/Times:Italic mpi} - Lenses 200 (21 Bildpaare)", \
	 "round_time_mpi.csv" using 1:4 with linespoints dashtype 3 pointtype 7 lw 3 lc 2 t "{/Times:Italic mpi} - Lenses 500 (11 Bildpaare)", \
	 "round_time_mpi.csv" using 1:5 with linespoints dashtype 3 pointtype 9 lw 3 lc 3 t "{/Times:Italic mpi} - Lenses 1500 (14 Bildpaare)"
