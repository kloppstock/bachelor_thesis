...
\begin{center}
	\begin{figure}[htbp]
		...
		\begin{tikzpicture}[node distance=1cm]
			...
			\node[]() at (0, -6cm){};
		\end{tikzpicture}
		\caption{Übersicht der Template-Matching-Parameter}
		\label{fig:tm_param}
	\end{figure}
\end{center}

\correctme{bei tm parameter 2. durchlauf erwähnen}
