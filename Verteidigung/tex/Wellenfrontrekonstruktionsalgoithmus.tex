...
\only<1-5> {
\begin{tikzpicture}
\node at (-5,0) {\includegraphics[width=0.35\linewidth]{pdf/graph_main}};
\only<2-4>{\node at (-2,0) {\includegraphics[width=0.17\linewidth]{pdf/graph_speckle}}};
...
\only<6>{\node at (-2,0) {\includegraphics[width=0.17\linewidth]{pdf/graph_fc}}};
...
\begin{center}
\includegraphics[width=0.4\linewidth]{pdf/graph_init}
\end{center}
\end{frame}
